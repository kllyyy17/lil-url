...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "lil-url.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "lil-url.com/" + this.state.preferedAlias
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Customize lil url</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">lil-url.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
